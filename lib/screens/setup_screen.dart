...
class _SetupScreenState extends State<SetupScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _opacityController = AnimationController(
      ...
      setState(() {}); // This triggers a rebuild when the animation value changes
    });
    super.initState();
  }
    @override
  void dispose() {
    _opacityController.dispose(); // Dispose the controller when the widget is removed
    super.dispose();
  }
              ...
              Card(
                ...
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.only(
                    ...
                    bottomRight: Radius.circular(12.0), // Round top-right corner
                    topLeft: Radius.zero, // Keep bottom-left corner rectangular
                    topRight: Radius.zero, // Keep bottom-right corner rectangular
                  ),
                ),
                child: Column(
                  children: [
